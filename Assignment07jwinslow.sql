...
-- 2022-11-28,jwinslow,Created File
-- 2022-11-29,jwinslow,started questions
-- 2022-11-30,jwinslow,reviewed views and date formatting
-- 2022-12-02,jwinslow,removed % and used Top 1000000 
-- 2022-12-03,jwinslow,checked for and removed typos in code
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_jwinslow')
	 Begin 
	  Alter Database [Assignment07DB_jwinslow] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_jwinslow;
	 End
	Create Database Assignment07DB_jwinslow;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_jwinslow;
...
-- Above orders the data alphabetically, use CAST to sort by InventoryDate
